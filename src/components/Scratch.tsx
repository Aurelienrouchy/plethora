            ...
            fileContents += `
                    window.addEventListener('load', function () {
                        ...
                        const sc = new ScratchCard('#js--sc--container', {
                            ...
                            imageForwardSrc: '${ticket.image}',
                            imageBackgroundSrc: 'https://images.unsplash.com/photo-1616091653488-e80acefedc83?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80',
                            clearZoneRadius: 30,
                            percentToFinish: 20,
                            nPoints: 30,
                            pointSize: 4,
